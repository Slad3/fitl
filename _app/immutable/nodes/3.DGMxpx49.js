import{t as i,a}from"../chunks/disclose-version.q5bePwqQ.js";import"../chunks/legacy.DPK5zCJG.js";import{a as o}from"../chunks/attributes.CaPm3nup.js";const s=""+new URL("../assets/spotifySearchImage.DwjxwRHI.jpg",import.meta.url).href;var r=i(`<article class="prose-gray prose-base text-white"><h1>Why FiTL Over Current/General Search Algorithms</h1> <div><h2>Advantages Over a General Search Algorithm</h2> <p>Why develop and/or learn an entire language just to do a more specific search?</p> <p>In my experience with typical applications (especially ones on the web), search works ever so
			...
			by Michael Jackson and "How Do I Make You Love Me" by The Weeknd from the query: <b>"you the make"</b>? "the" is not even in the title "How Do I Make You Love Me"?</p> <img${o("src",s)} alt="Spotify's Odd Filtering Algorithm"> <p>The Simple answer is that it doesn't get just search for exact (or close matches) in song
			...
			data the most.</p> <h2>So how does FiTL aim to fix the overall issue?</h2> <ol class=" space-y-1 list-disc list-outside"><li>FiTL allows the same kind of quick fuzzy filtering, but also allows for more specific
				...
				to further filter down search results</li></ol></div></article>`);function l(e){var t=r();a(e,t)}export{l as component};
