...
* @returns {any}
*/
export function fitl_filter(input_query, input_table, table_format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input_query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
