...
* @returns {any}
*/
export function test_json_input(input_table) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.test_json_input(retptr, addHeapObject(input_table));
...
* @returns {boolean}
*/
export function check_syntax(query, columns) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
export function fitl_filter(query, input_table) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.fitl_filter(retptr, ptr0, len0, addHeapObject(input_table));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
* @returns {any}
*/
export function fitl_filter_custom_table_format(query, input_table, table_format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.fitl_filter_custom_table_format(retptr, ptr0, len0, addHeapObject(input_table), ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
/**
*/
export const TableFormat = Object.freeze({ Custom:0,"0":"Custom",JsonArray:1,"1":"JsonArray", });
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('fitl_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
